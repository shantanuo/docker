...
PERL5OPT=-CA xpath -e "/feed/entry[author/name!='Aditya tamhankar' and author/name!='Dharmadhyaksha' and author/name!='नरेश सावे' and author/name!='अभय नातू' and author/name!='संतोष गोरे' and author/name!='Khirid_Harshad' and author/name!='Abhijitsathe']" /tmp/out1.txt >> /tmp/updated.txt

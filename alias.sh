...
echo "alias installminiconda='docker run -p 7778:7778 -t continuumio/miniconda /bin/bash -c \" conda  install -c conda-forge -y geopandas gdal tqdm jupyter && cd /home/ && jupyter notebook --ip=* --port=7778\" ' " >> ~/.bashrc
